...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "ummmah" , "Hmm" ,) || (event.body.toLowerCase() == "simsimi")) {
     return api.sendMessage("আমি কি তোর জামাই যে তুই আমাকে কিস করলি", "তাহলে কাছছ আসসো করা করে আমি ও একটা kiss 💋 দেই তোমায়" ,threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bc","Mc",) || (event.body.toLowerCase() == "mc")) {
  ...
  if ((event.body.toLowerCase() == "TONMOY") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("চুপ শালা হারামি মিথ্যা কথা কস আমার Boss TONMOY", threadID);
   };

   if ((event.body.toLowerCase() == "@Dx Maria") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস TONMOY এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "mim") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস TONMOY এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে গার্লফ্রেন্ড টা দিয়ে দে..!🌚⛏️🌶️", " ধন্যবাদ না দিয়ে আমার সাথে প্রেম কর চুরি কিনা দিমু",threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>TONMOY 😍", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "কি করো") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("আমার কোনো টাজ নাই , তুমি কি করো" ,🌚🐸🌶️🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("প্রেম ভালোবাসা কিছুই না সবি হরমোনের উত্তেজনা.!🙂💋🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Ami Tonmoy") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("BOSS আসসালামুয়ালাইকুম কেমন আছেন..?☺️", threadID);
   };
  mess = "{name}"
  ...
  if (event.body.indexOf("/Bot") == 0 || (event.body.indexOf("/bot") == 0)) {
    ...
    return api.sendMessage("কি কস", threadID, messageID);
  };
